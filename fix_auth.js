...
content = content.replace(
  ...
  'try { return (await client.db(DB_NAME).collection(USERS_COLLECTION).findOne({ email: normalizedEmail })) || fallback; } catch (e) { console.error("Mongo Auth Fallback Used:", e); return fallback; }\n//'
);
