              ...
              <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
                ...
                <ul className="text-sm space-y-3 text-slate-600">
                  ...
                  <li className="flex items-start">
                    ...
                    <span>When 10+ complaints of the same category cluster within 8km, a <strong className="text-slate-800">Red Polygon Hotspot</strong> is formed via PostGIS DBSCAN.</span>
                  </li>
                  <li className="flex items-start">
